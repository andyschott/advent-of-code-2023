...
{
    private readonly DayFourPuzzle _puzzle = new();

    private const string SampleInput = @"Card 1: 41 48 83 86 17 | 83 86  6 31 17  9 48 53
...
Card 6: 31 18 13 56 72 | 74 77 10 23 35 67 36 11";
    ...
    public void SingleCardScore(string input, int expectedResult)
    {
        var result = _puzzle.PartOne(input);
